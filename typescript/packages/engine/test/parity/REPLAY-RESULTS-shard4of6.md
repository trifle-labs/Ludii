...
| COMPILE_FAIL | 14 | 3.3% |
| START_FAIL | 0 | 0.0% |
| MOVE_MISMATCH | 305 | 71.6% |
| WINNER_MISMATCH | 52 | 12.2% |
| OUTCOME_OK | 45 | 10.6% |
...
- **Ply:** 23
- **Recorded move:** `mover=2,from=24,to=12`
- **TS moves available:** 4
- **Sample TS moves:** mover=2,from=24,to=23,isPass=false, mover=2,from=24,to=18,isPass=false, mover=2,from=24,to=14,isPass=false
- **Detail:** No matching TS move

### Example 2: `board/hunt/Demala Diviyan Keliya`
- **Ply:** 0
- **Recorded move:** `mover=1,from=9,to=10`
...
- **Ply:** 0
- **Recorded move:** `mover=1,from=6,to=15`
- **TS moves available:** 4
...
- **Ply:** 0
- **Recorded move:** `mover=1,from=10,to=5`
...
- **Ply:** 1
- **Recorded move:** `mover=2,from=5,to=16`
