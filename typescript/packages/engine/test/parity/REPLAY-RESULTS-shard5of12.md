...
- **Sample TS moves:** mover=1,from=6,to=10,isPass=false, mover=1,from=12,to=9,isPass=false, mover=1,from=6,to=7,isPass=false
- **Detail:** No matching TS move
