 ...
 */
function isPassRecordedMove(recMove) {
 ...
 */
function isPlacementRecordedMove(recMove) {
...
function recordedDecisionType(recMove) {
  for (const a of recMove.actions) {
 ...
 */
function findMatchingMove(tsMoves, recMove) {
