...
| COMPILE_FAIL | 0 | 0.0% |
| START_FAIL | 0 | 0.0% |
| MOVE_MISMATCH | 81 | 38.0% |
| WINNER_MISMATCH | 6 | 2.8% |
| OUTCOME_OK | 103 | 48.4% |
| REPLAY_OK_NO_OUTCOME | 23 | 10.8% |
...
- `board/race/escape/Romavoa`: **1** mismatches
...
### Example 3: `board/hunt/To Kinegi tou Lagou`
- **Ply:** 2
...
### Example 4: `board/race/escape/Chaupar`
- **Ply:** 72
- **Recorded move:** `mover=1,from=61,to=55`
- **TS moves available:** 6
- **Sample TS moves:** mover=1,from=17,to=48,isPass=false, mover=1,from=17,to=48,isPass=false, mover=1,from=17,to=34,isPass=false
- **Detail:** No matching TS move

### Example 5: `board/race/escape/Grand Trictrac`
- **Ply:** 0
