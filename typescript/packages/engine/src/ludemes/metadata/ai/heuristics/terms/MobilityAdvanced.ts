// @java Core/src/metadata/ai/heuristics/terms/MobilityAdvanced.java
...
/**
 * Defines an advanced heuristic term based on mobility, taking into account
 * the number of legal moves available without repeating previous states.
 *
 * @author Dennis Soemers
 */
export class MobilityAdvanced extends HeuristicTerm {
  /**
  ...
  override copy(): MobilityAdvanced {
    return new MobilityAdvanced(this.transformation, this.weight);
  }
