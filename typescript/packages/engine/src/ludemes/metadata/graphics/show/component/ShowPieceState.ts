 ...
 *
 * @java metadata/graphics/show/component/ShowPieceState.java
 *
...
/**
 * @java metadata/graphics/show/component/ShowPieceState.java — class ShowPieceState implements GraphicsItem
 */
export class ShowPieceState {
  /** RoleType condition. */
