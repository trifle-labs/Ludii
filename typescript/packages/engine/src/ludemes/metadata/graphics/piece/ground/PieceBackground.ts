 ...
 * PieceBackground.ts
 *
 * @java metadata/graphics/piece/ground/PieceBackground.java
 *
...
/**
 * @java metadata/graphics/piece/ground/PieceBackground.java — class PieceBackground implements GraphicsItem
 */
export class PieceBackground implements GraphicsItem {
  /** RoleType condition. */
   ...
   * @java PieceBackground(RoleType, String, Integer, Integer, Integer, String, String, Colour, Colour, Float, Float, Float, Integer, Float, Float)
   */
  constructor(
  ...
  /** @java PieceBackground.concepts(Game) */
  concepts(_game: unknown): unknown {
    return {};
  }

  /** @java PieceBackground.gameFlags(Game) */
  gameFlags(_game: unknown): number {
    return 0;
  }

  /** @java PieceBackground.needRedraw() */
  needRedraw(): boolean {
    return false;
  }
}
