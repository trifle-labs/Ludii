// @java Core/src/metadata/graphics/board/ground/BoardBackground.java BoardBackground
/**
 * Java parity:
 * - Core/src/metadata/graphics/board/ground/BoardBackground.java — faithful data-class port.
...
export class BoardBackground {
  ...
  /**
   * @param image      Name of the background image to draw (null = board outline).
