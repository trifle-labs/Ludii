...
import type { Start1to1 } from "./start/Start.js";
import { Phase as PhaseCtor } from "./phase/Phase.js";
import { Play1to1 as PlayCtor } from "./play/Play1to1.js";
...
export class Rules1to1 {
  ...
  public readonly start: Start1to1 | null;
   ...
   */
  public constructor(meta: Meta | null | undefined, start: Start1to1 | null | undefined, play: Play1to1, end: End);
  ...
  public constructor(
    ...
    if (isPhaseArray(phasesOrEnd)) {
      ...
      for (const phase of this.phases) {
        if (phase.play == null) {
          if (play == null) throw new Error("Rules1to1: phase is missing play and no shared play was provided.");
          phase.setPlay(play);
        } else if (play != null) {
