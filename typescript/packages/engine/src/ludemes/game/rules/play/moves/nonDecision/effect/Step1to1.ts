...
// COMPASS tables + resolveRelativeDir/isSingleDir moved to game/util/directions/RelativeDirection.ts
// (the Java-mirrored home); re-exported here for the bespoke path during the transition.
import { resolveRelativeDir, isSingleDir } from "../../../../../util/directions/RelativeDirection.js";
export { resolveRelativeDir, isSingleDir };
