 ...
 * GamePlayer1to1 (slot 0 is null, 1..P are the real players).
 *
 * Named GamePlayers1to1 to avoid collision with the unrelated
...
import { GamePlayer1to1 } from "./GamePlayer1to1.js";
 ...
 * @java game/players/Players.java
 */
export class GamePlayers1to1 {
  /**
   * Player records: slot 0 is null, player indices are 1..P.
   * @java Players.players
   */
  private readonly _players: Array<GamePlayer1to1 | null>;
   ...
   */
  public players(): ReadonlyArray<GamePlayer1to1 | null> {
   ...
   */
  public get(index: number): GamePlayer1to1 | null {
