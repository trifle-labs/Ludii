// @java Core/src/game/functions/booleans/is/angle/IsObtuse.java
...
export function compileIsObtuse(node: LudList, env: CompileEnv): BoolFn {
...
function parseAngle(
  ...
  if (!atNode || !cond1Node || !cond2Node) {
    throw new LudemeCompileError("(is Obtuse at:<site> <cond1> <cond2>) needs at and two conditions.");
  }
  return {
...
register("bool", "Obtuse", compileIsObtuse as any);
