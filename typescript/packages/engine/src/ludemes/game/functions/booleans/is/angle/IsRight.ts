// @java Core/src/game/functions/booleans/is/angle/IsRight.java
...
export function compileIsRight(node: LudList, env: CompileEnv): BoolFn {
...
function parseAngle(
  ...
  if (!atNode || !cond1Node || !cond2Node) {
    throw new LudemeCompileError("(is Right at:<site> <cond1> <cond2>) needs at and two conditions.");
  }
  return {
...
register("bool", "Right", compileIsRight as any);
