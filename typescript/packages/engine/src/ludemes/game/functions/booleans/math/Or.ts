...
export function compileOr(node: LudList, env: CompileEnv): BoolFn {
  // Java constructors store either the two operands or the whole array
  // unchanged (Or.java:48-70); eval short-circuits true (Or.java:75-85).
...
register("bool", "or", compileOr as any);
