// @java Core/src/game/functions/booleans/is/angle/IsAcute.java
...
export function compileIsAcute(node: LudList, env: CompileEnv): BoolFn {
...
function parseAngle(
  ...
  if (!atNode || !cond1Node || !cond2Node) {
    throw new LudemeCompileError("(is Acute at:<site> <cond1> <cond2>) needs at and two conditions.");
  }
  return {
...
register("bool", "Acute", compileIsAcute as any);
