// @java Core/src/game/functions/booleans/is/tree/IsSpanningTree.java
...
export function compileIsSpanningTree(_node: LudList, _env: CompileEnv): BoolFn {
...
register("bool", "SpanningTree", compileIsSpanningTree as any);
