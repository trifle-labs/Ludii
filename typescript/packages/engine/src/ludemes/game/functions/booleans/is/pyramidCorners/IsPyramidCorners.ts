// @java Core/src/game/functions/booleans/is/pyramidCorners/IsPyramidCorners.java
...
export function compileIsPyramidCorners(_node: LudList, _env: CompileEnv): BoolFn {
...
register("bool", "PyramidCorners", compileIsPyramidCorners as any);
