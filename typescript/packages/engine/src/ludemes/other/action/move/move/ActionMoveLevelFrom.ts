 ...
 *
 * Faithful 1:1 transliteration of other.action.move.move.ActionMoveLevelFrom.
 *
...
export class ActionMoveLevelFrom extends ActionMoveTopPiece {
  // -------------------------------------------------------------------------
  ...
  override apply(context: LudiiContext, _store: boolean): Action {
    ...
    csTo.addItemStackGeneric(context.state(), this.toSite, what, who,
      effectiveState, effectiveRotation, effectiveValue, this.typeToField, context.game());
