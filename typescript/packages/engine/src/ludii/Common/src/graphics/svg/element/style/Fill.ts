// @java Common/src/graphics/svg/element/style/Fill.java
 ...
 *
 * @java graphics/svg/element/style/Fill.java
 * @author cambolbro
 */
export class Fill extends StyleBase {
  ...
  /** @java Fill.newInstance() */
  public override newInstance(): Element | null {
    return null;
  }

  /** @java Fill.render(Graphics2D, double, double, Color, Color, Color) */
