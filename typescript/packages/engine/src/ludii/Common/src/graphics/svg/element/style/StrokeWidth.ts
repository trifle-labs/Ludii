// @java Common/src/graphics/svg/element/style/StrokeWidth.java
 ...
 *
 * @java graphics/svg/element/style/StrokeWidth.java
 * @author cambolbro
 */
export class StrokeWidth extends StyleBase {
  // Format:  stroke-width="1"

  /** @java StrokeWidth.width */
  private readonly _width: number = 1;
  ...
  /** @java StrokeWidth.newInstance() */
  public override newInstance(): Element | null {
    return null;
  }

  /** @java StrokeWidth.render(Graphics2D, double, double, Color, Color, Color) */
