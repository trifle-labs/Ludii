// @java Common/src/graphics/svg/element/style/StrokeOpacity.java
 ...
 *
 * @java graphics/svg/element/style/StrokeOpacity.java
 * @author cambolbro
 */
export class StrokeOpacity extends StyleBase {
  // Format:  stroke-opacity=".5"

  /** @java StrokeOpacity.opacity */
  ...
  /** @java StrokeOpacity.load(String) */
  ...
  /** @java StrokeOpacity.newInstance() */
  public override newInstance(): Element | null {
    return null;
  }

  /** @java StrokeOpacity.render(Graphics2D, double, double, Color, Color, Color) */
