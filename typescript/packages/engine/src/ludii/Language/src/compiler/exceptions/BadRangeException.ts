// @java Language/src/compiler/exceptions/BadRangeException.java
...
/**
 * @java compiler/exceptions/BadRangeException.java
 * @author cambolbro
 */
export class BadRangeException extends CompilerException {
  /** @java BadRangeException.serialVersionUID */
  // serialVersionUID = 1L

  /** @java BadRangeException.limit */
  private readonly limit: number;

  /**
   * @param limit
   * @java BadRangeException(int)
   */
  constructor(limit: number) {
    super();
    this.name = "BadRangeException";
    this.limit = limit;
  }

  /**
   * @java BadRangeException.getMessageBody(String)
   */
  public override getMessageBody(gameDescription: string): string {
    ...
    sb.push("<br/>");
    sb.push("<p>");
    sb.push(highlightText(safeDescription, "..", "font", "red"));
    sb.push("</p>");
    sb.push("</html>");
  ...
  /**
   * @java BadRangeException.getMessageTitle()
   */
