// @java Features/src/features/spatial/instances/SingleMustNotWhatEdge.java
 ...
 *
 * @java features/spatial/instances/SingleMustNotWhatEdge.java
 * @author Dennis Soemers
 */
export class SingleMustNotWhatEdge extends AtomicProposition {
   ...
   * @param chunkSize
   * @java SingleMustNotWhatEdge(int, int, int)
   */
  ...
  /** @java SingleMustNotWhatEdge.matches(State) */
  ...
  /** @java SingleMustNotWhatEdge.onlyRequiresSingleMustEmpty() */
  public onlyRequiresSingleMustEmpty(): boolean {
    return false;
  }

  /** @java SingleMustNotWhatEdge.onlyRequiresSingleMustWho() */
  public onlyRequiresSingleMustWho(): boolean {
    return false;
  }

  /** @java SingleMustNotWhatEdge.onlyRequiresSingleMustWhat() */
  public onlyRequiresSingleMustWhat(): boolean {
    return false;
  }

  /** @java SingleMustNotWhatEdge.graphElementType() */
  public graphElementType(): "Cell" | "Edge" | "Vertex" {
    return "Edge";
  }

  /** @java SingleMustNotWhatEdge.addMaskTo(ChunkSet) */
  public addMaskTo(chunkSet: ChunkSet): void {
    chunkSet.addMask(this.wordIdx, this.mask);
  }

  /** @java SingleMustNotWhatEdge.stateVectorType() */
  public stateVectorType(): StateVectorTypes {
    return StateVectorTypes.What;
  }

  /** @java SingleMustNotWhatEdge.testedSite() */
  public testedSite(): number {
    return this.site;
  }

  /** @java SingleMustNotWhatEdge.value() */
  public value(): number {
    return this._value;
  }

  /** @java SingleMustNotWhatEdge.negated() */
  ...
  /** @java SingleMustNotWhatEdge.provesIfTrue(AtomicProposition, Game) */
  ...
  /** @java SingleMustNotWhatEdge.disprovesIfTrue(AtomicProposition, Game) */
  ...
  /** @java SingleMustNotWhatEdge.provesIfFalse(AtomicProposition, Game) */
  ...
  /** @java SingleMustNotWhatEdge.disprovesIfFalse(AtomicProposition, Game) */
  ...
  /** @java SingleMustNotWhatEdge.hashCode() */
  ...
  /** @java SingleMustNotWhatEdge.equals(Object) */
  ...
  /** @java SingleMustNotWhatEdge.toString() */
  public override toString(): string {
    return "[Edge " + this.site + " must NOT contain " + this._value + "]";
  }
