// @java Features/src/features/spatial/instances/SingleMustWhatEdge.java
 ...
 *
 * @java features/spatial/instances/SingleMustWhatEdge.java
 * @author Dennis Soemers
 */
export class SingleMustWhatEdge extends AtomicProposition {
   ...
   * @param mustWhatValue
   * @param chunkSize
   * @java SingleMustWhatEdge(int, int, int)
   */
  ...
  /** @java SingleMustWhatEdge.matches(State) */
  ...
  /** @java SingleMustWhatEdge.onlyRequiresSingleMustEmpty() */
  public onlyRequiresSingleMustEmpty(): boolean {
    return false;
  }

  /** @java SingleMustWhatEdge.onlyRequiresSingleMustWho() */
  public onlyRequiresSingleMustWho(): boolean {
    return false;
  }

  /** @java SingleMustWhatEdge.onlyRequiresSingleMustWhat() */
  public onlyRequiresSingleMustWhat(): boolean {
    return true;
  }

  /** @java SingleMustWhatEdge.graphElementType() */
  public graphElementType(): "Cell" | "Edge" | "Vertex" {
    return "Edge";
  }

  /** @java SingleMustWhatEdge.addMaskTo(ChunkSet) */
  public addMaskTo(chunkSet: ChunkSet): void {
    chunkSet.addMask(this.wordIdx, this.mask);
  }

  /** @java SingleMustWhatEdge.stateVectorType() */
  public stateVectorType(): StateVectorTypes {
    return StateVectorTypes.What;
  }

  /** @java SingleMustWhatEdge.testedSite() */
  public testedSite(): number {
    return this.site;
  }

  /** @java SingleMustWhatEdge.value() */
  public value(): number {
    return this._value;
  }

  /** @java SingleMustWhatEdge.negated() */
  ...
  /** @java SingleMustWhatEdge.provesIfTrue(AtomicProposition, Game) */
  ...
  /** @java SingleMustWhatEdge.disprovesIfTrue(AtomicProposition, Game) */
  ...
  /** @java SingleMustWhatEdge.provesIfFalse(AtomicProposition, Game) */
  ...
  /** @java SingleMustWhatEdge.disprovesIfFalse(AtomicProposition, Game) */
  ...
  /** @java SingleMustWhatEdge.hashCode() */
  ...
  /** @java SingleMustWhatEdge.equals(Object) */
  ...
  /** @java SingleMustWhatEdge.toString() */
  public override toString(): string {
    return "[Edge " + this.site + " must contain " + this._value + "]";
  }
