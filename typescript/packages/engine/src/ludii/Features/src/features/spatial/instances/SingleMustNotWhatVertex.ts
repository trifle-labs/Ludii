// @java Features/src/features/spatial/instances/SingleMustNotWhatVertex.java
 ...
 *
 * @java features/spatial/instances/SingleMustNotWhatVertex.java
 * @author Dennis Soemers
 */
export class SingleMustNotWhatVertex extends AtomicProposition {
   ...
   * @param chunkSize
   * @java SingleMustNotWhatVertex(int, int, int)
   */
  ...
  /** @java SingleMustNotWhatVertex.matches(State) */
  public override matches(state: State): boolean {
    return !state.containerStates()[0]!.matchesWhatVertex(this.wordIdx, this.mask, this.matchingWord);
  }

  /** @java SingleMustNotWhatVertex.onlyRequiresSingleMustEmpty() */
  public onlyRequiresSingleMustEmpty(): boolean {
    return false;
  }

  /** @java SingleMustNotWhatVertex.onlyRequiresSingleMustWho() */
  public onlyRequiresSingleMustWho(): boolean {
    return false;
  }

  /** @java SingleMustNotWhatVertex.onlyRequiresSingleMustWhat() */
  public onlyRequiresSingleMustWhat(): boolean {
    return false;
  }

  /** @java SingleMustNotWhatVertex.graphElementType() */
  public graphElementType(): "Cell" | "Edge" | "Vertex" {
    return "Vertex";
  }

  /** @java SingleMustNotWhatVertex.addMaskTo(ChunkSet) */
  public addMaskTo(chunkSet: ChunkSet): void {
    chunkSet.addMask(this.wordIdx, this.mask);
  }

  /** @java SingleMustNotWhatVertex.stateVectorType() */
  public stateVectorType(): StateVectorTypes {
    return StateVectorTypes.What;
  }

  /** @java SingleMustNotWhatVertex.testedSite() */
  public testedSite(): number {
    return this.site;
  }

  /** @java SingleMustNotWhatVertex.value() */
  public value(): number {
    return this._value;
  }

  /** @java SingleMustNotWhatVertex.negated() */
  ...
  /** @java SingleMustNotWhatVertex.provesIfTrue(AtomicProposition, Game) */
  ...
  /** @java SingleMustNotWhatVertex.disprovesIfTrue(AtomicProposition, Game) */
  ...
  /** @java SingleMustNotWhatVertex.provesIfFalse(AtomicProposition, Game) */
  ...
  /** @java SingleMustNotWhatVertex.disprovesIfFalse(AtomicProposition, Game) */
  ...
  /** @java SingleMustNotWhatVertex.hashCode() */
  ...
  /** @java SingleMustNotWhatVertex.equals(Object) */
  ...
  /** @java SingleMustNotWhatVertex.toString() */
  public override toString(): string {
    return "[Vertex " + this.site + " must NOT contain " + this._value + "]";
  }
