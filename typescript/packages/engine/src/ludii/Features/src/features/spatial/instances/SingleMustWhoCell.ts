// @java Features/src/features/spatial/instances/SingleMustWhoCell.java
 ...
 *
 * @java features/spatial/instances/SingleMustWhoCell.java
 * @author Dennis Soemers
 */
export class SingleMustWhoCell extends AtomicProposition {
   ...
   * @param mustWhoValue
   * @param chunkSize
   * @java SingleMustWhoCell(int, int, int)
   */
  ...
  /** @java SingleMustWhoCell.provesIfTrue(AtomicProposition, Game) */
  ...
  /** @java SingleMustWhoCell.disprovesIfTrue(AtomicProposition, Game) */
  ...
  /** @java SingleMustWhoCell.provesIfFalse(AtomicProposition, Game) */
  ...
  /** @java SingleMustWhoCell.disprovesIfFalse(AtomicProposition, Game) */
  ...
  /** @java SingleMustWhoCell.hashCode() */
  ...
  /** @java SingleMustWhoCell.equals(Object) */
  ...
  /** @java SingleMustWhoCell.toString() */
  public override toString(): string {
    return "[Cell " + this.site + " must be owned by Player " + this._value + "]";
  }
