// @java AI/src/policies/softmax/SoftmaxFromMetadataPlayout.java
 ...
 *
 * @java policies/softmax/SoftmaxFromMetadataPlayout.java
 * @author Dennis Soemers
 */
export class SoftmaxFromMetadataPlayout extends SoftmaxPolicy {
   ...
   * @java SoftmaxFromMetadataPlayout(double)
   */
  public constructor(epsilon: number) {
    super();
    this.friendlyName = "Softmax Policy (Playout features from Game metadata)";
  ...
  /**
   * @java SoftmaxFromMetadataPlayout.initAI(Game, int)
   */
  public override initAI(game: unknown, playerID: number): void {
    const g = game as Game;
    const featuresMetadata: FeaturesMetadata | null = g.metadata().ai().features();
    ...
    if (featuresMetadata !== null) {
      ...
      for (const featureSet of featuresMetadata.featureSets()) {
        ...
        if (isShared)
          ...
          (wrapped as unknown as { addFeatureSetWeights: (...a: unknown[]) => void })
            .addFeatureSetWeights(role.owner(), featureSet.featureStrings(), featureSet.playoutWeights(), featureSetsList, linFuncs);
      }
      ...
      const featureTrees: FeatureTrees | null = g.metadata().ai().trainedFeatureTrees();
      if (featureTrees !== null) {
        this.wrappedSoftmax = SoftmaxFromMetadataPlayout._constructLogitTreePolicy(featureTrees, this.epsilon);
  ...
  /**
   * @java SoftmaxFromMetadataPlayout.supportsGame(Game)
   */
  ...
  /**
   * @java SoftmaxFromMetadataPlayout.runPlayout(MCTS, Context)
   */
  ...
  /**
   * @java SoftmaxFromMetadataPlayout.playoutSupportsGame(Game)
   */
  ...
  /**
   * @java SoftmaxFromMetadataPlayout.backpropFlags()
   */
  ...
  /**
   * @java SoftmaxFromMetadataPlayout.customise(String[])
   */
  public override customise(_inputs: string[]): void {
    console.error("customise() not implemented for SoftmaxFromMetadataPlayout!");
  }

  /**
   * @java SoftmaxFromMetadataPlayout.computeLogit(Context, Move)
   */
  ...
  /**
   * @java SoftmaxFromMetadataPlayout.computeDistribution(Context, FastArrayList, boolean)
   */
  ...
  /**
   * @java SoftmaxFromMetadataPlayout.selectAction(Game, Context, double, int, int)
   */
  ...
  /**
   * Escape hatch for SoftmaxPolicyLogitTree.constructPolicy — loaded dynamically to avoid circular dep
