// @java AI/src/search/mcts/playout/PlayoutHS.java
 ...
 *
 * @java search.mcts.playout.PlayoutHS
 * @author Dennis Soemers
 */
export class PlayoutHS implements PlayoutStrategy {
   ...
   * no limit.
   *
   * @java PlayoutHS.playoutTurnLimit
   */
   ...
   *
   * @java PlayoutHS.heuristicsFilepath
   */
  ...
  /** @java PlayoutHS.threshold() */
  public threshold(): number {
    return this.fraction;
  }

  /** @java PlayoutHS.setThreshold(int) */
  public setThreshold(value: number): void {
    this.fraction = value;
    // friendlyName = "HS (1/" + fraction + ")"  -- not stored in TS version
  }

  /** @java PlayoutHS.continuation() */
  public getContinuation(): boolean {
    return this.continuation;
  }

  /** @java PlayoutHS.setContinuation(boolean) */
  ...
  /** @java PlayoutHS.runPlayout(MCTS, Context) */
  ...
  /** @java PlayoutHS.playoutSupportsGame(Game) */
  ...
  /** @java PlayoutHS.customise(String[]) */
  ...
  /** @java PlayoutHS.backpropFlags() */
  public backpropFlags(): number {
    return 0;
  }

  /** @java PlayoutHS.initAI(Game, int) */
  ...
  /** @java PlayoutHS.selectAction(Game, Context, double, int, int) */
  public selectAction(
    _game: unknown,
    _context: Context,
    _maxSeconds: number,
